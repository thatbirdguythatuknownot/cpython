...
EXPORT_FUNC(PyCereal_New)
EXPORT_FUNC(PyCereal_FromFields)
EXPORT_FUNC(PyCereal_FromFieldsOverflow)
EXPORT_FUNC(PyCereal_Prepare)
EXPORT_FUNC(PyCereal_Eat)
EXPORT_FUNC(PyCereal_Finish)
EXPORT_FUNC(PyCereal_Add)
EXPORT_FUNC(PyCereal_Subtract)
EXPORT_FUNC(PyCereal_Multiply)
EXPORT_FUNC(PyCereal_Divide)
EXPORT_FUNC(PyCereal_Resize)
EXPORT_FUNC(PyCereal_ResizeOverflow)
EXPORT_FUNC(PyCereal_AddSizeAbsolute)
EXPORT_FUNC(PyCereal_SubtractSizeAbsolute)
EXPORT_FUNC(PyCereal_MultiplySizeAbsolute)
EXPORT_FUNC(PyCereal_AddSizeRelative)
EXPORT_FUNC(PyCereal_MultiplySizeRelative)
